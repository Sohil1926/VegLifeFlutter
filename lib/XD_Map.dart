...
import './XD_MapCompanion.dart';

class XD_Map extends StatelessWidget {
  XD_Map({
    Key key,
  }) : super(key: key);
  @override
        ...
        children: <Widget>[
          Transform.translate(
            ...
            child:
                ...
                SvgPicture.string(
              _shapeSVG_a03be8a38f04490688a803d5ef500733,
                ...
                Transform.translate(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      SvgPicture.string(
                        _shapeSVG_a09112031fbf4d5895db82f2b741b16d,
                        allowDrawingOutsideViewBox: true,
                      ),
                    ],
                  ),
          ...
          Transform.translate(
            offset: Offset(46.0, 284.0),
            child: Container(
              width: 283.0,
              height: 283.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.elliptical(141.5, 141.5)),
                color: const Color(0x577bed8d),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(99.0, 337.0),
            child: Container(
              width: 178.0,
              height: 178.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.elliptical(89.0, 89.0)),
                color: const Color(0x577bed8d),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(143.0, 382.0),
            child: SvgPicture.string(
              _shapeSVG_a51b8682f18e4333a21fa25dd2c101e4,
              allowDrawingOutsideViewBox: true,
            ),
          ),
          Transform.translate(
...
const String _shapeSVG_a03be8a38f04490688a803d5ef500733 =
    '<svg viewBox="-503.0 30.0 894.0 1788.0" ><defs><pattern id="image" patternUnits="userSpaceOnUse" width="894.0" height="1788.0"><image xlink:href="null" x="0" y="0" width="894.0" height="1788.0" /></pattern></defs><path transform="translate(-503.0, 30.0)" d="M 0 0 L 894 0 L 894 1788 L 0 1788 L 0 0 Z" fill="url(#image)" fill-opacity="0.35" stroke="none" stroke-width="1" stroke-opacity="0.35" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _shapeSVG_a09112031fbf4d5895db82f2b741b16d =
...
const String _shapeSVG_a51b8682f18e4333a21fa25dd2c101e4 =
    '<svg viewBox="143.0 382.0 89.0 89.0" ><path transform="translate(143.0, 382.0)" d="M 44.5 0 C 69.07666778564453 0 89 19.92333030700684 89 44.5 C 89 69.07666778564453 69.07666778564453 89 44.5 89 C 19.92333030700684 89 0 69.07666778564453 0 44.5 C 0 19.92333030700684 19.92333030700684 0 44.5 0 Z" fill="#7bed8d" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
