...
import './XD_ComfirmPurchase.dart';
import 'package:adobe_xd/specific_rect_clip.dart';

class XD_Offersfortoday extends StatelessWidget {
  XD_Offersfortoday({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      SvgPicture.string(
                        _shapeSVG_6b0bd76f1cfb45f7aba99788aa0e6dc2,
          ...
          Transform.translate(
            offset: Offset(22.0, 161.0),
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 325, 963),
              child: UnconstrainedBox(
                ...
                child: Container(
                  ...
                  child: GridView.count(
                    ...
                    crossAxisSpacing: 20,
                    crossAxisCount: 1,
                    childAspectRatio: 1.0906040268456376,
                    children: [
                      {},
                      {},
                      {},
                              ...
                              child: PageLink(
                                links: [
                                  PageLinkInfo(
                                    ...
                                    duration: 0.3,
                                    ease: Curves.easeOut,
                                    pageBuilder: () => XD_ComfirmPurchase(),
                                  ),
                                ],
                                child: Container(
                                  width: 307.0,
...
const String _shapeSVG_6b0bd76f1cfb45f7aba99788aa0e6dc2 =
